...
export function AtualizacaoDisponivel() {
  ...
  return (
    <div className="no-print fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-full bg-slate-900 text-white pl-4 pr-2 py-2 shadow-elevated animate-slide-up">
